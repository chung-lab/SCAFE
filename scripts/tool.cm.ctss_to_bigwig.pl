...
=head1 SYNOPSIS
 ...
 Single Cell Analysis of Five'End (SCAFE) Suite: --> tool.cm.remove_strand_invader.pl <--
 ...
 For demo, cd to SCAFE dir and run,
   ./scripts/tool.cm.ctss_to_bigwig.pl \
...
my ($curntTimeStamp) = &timeStamp();#->583
my $ARGVStr = join "\n", (&currentTime(), $scriptAbsPath, @ARGV);#->293
...
my ($ctss_bed_path, $genome, $outputPrefix, $outDir) = &readParameters();#->521
#<\section>
#====================================================================================================================================================#
...
&logCalledCMDAndScript($ARGVStr, $result_script_dir, $scriptAbsPath);#->342
...
my ($chrom_size_path) = &checkChromSizePath($genome);#->191
my ($bedGraphToBigWig_bin) = &checkBedGraphToBigWigVersion();#->161
my ($total_count) = &getTotalCount($ctss_bed_path);#->311
&convertCTSS($ctss_bed_path, $result_wig_dir, $result_bed_dir, $outputPrefix, $chrom_size_path, $bedGraphToBigWig_bin, $total_count);#->211
...
&printOutputFileListAndReadme($ARGVStr, $paramTag, $outDir);#->367
...
#
#	checkTools [n=1]:
#		checkBedGraphToBigWigVersion
#
#	general [n=6]:
#		checkBedGraphToBigWigVersion, currentTime, logCalledCMDAndScript
...
#
#	unassigned [n=2]:
#		checkChromSizePath, getTotalCount
#
#====================================================================================================================================================#

sub checkBedGraphToBigWigVersion {
#....................................................................................................................................................#
#	subroutineCategory: general, checkTools
#	dependOnSub: reportAndLogStatus|561
#	appearInSub: >none
#	primaryAppearInSection: 3_count|109
#	secondaryAppearInSection: >none
#	input: none
#	output: $bedGraphToBigWig_bin
#	toCall: my ($bedGraphToBigWig_bin) = &checkBedGraphToBigWigVersion();
#	calledInLine: 113
#....................................................................................................................................................#

	my $dirPath = dirname(rel2abs($0));
	my $bedGraphToBigWig_bin = "bedGraphToBigWig";
	...
	if ($stdOut =~ m/bedGraphToBigWig v (\S+)/) {
		...
		$bedGraphToBigWig_bin = "$dirPath/../resources/bin/bedGraphToBigWig/bedGraphToBigWig";
		if ($stdOut =~ m/bedGraphToBigWig v (\S+)/) {
			&reportAndLogStatus("Checking: bedGraphToBigWig version: $1", 0, "\n");#->561
		} else {
...
#	dependOnSub: >none
#	appearInSub: printStartOrFinishMessage|487, reportAndLogStatus|561
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 2_defineOutDirPath|90, 4_finishingTasks|121
#	input: none
#	output: $runTime
#	toCall: my ($runTime) = &currentTime();
#	calledInLine: 63, 503, 507, 512, 516, 577, 578
#....................................................................................................................................................#
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 2_defineOutDirPath|90
#	secondaryAppearInSection: >none
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 4_finishingTasks|121
#	secondaryAppearInSection: >none
...
#....................................................................................................................................................#
#	subroutineCategory: general
#	dependOnSub: currentTime|293
#	appearInSub: >none
#	primaryAppearInSection: 2_defineOutDirPath|90, 4_finishingTasks|121
#	secondaryAppearInSection: >none
#	input: $StartOrFinishMessage
#	output: none
#	toCall: &printStartOrFinishMessage($StartOrFinishMessage);
#	calledInLine: 104, 125
#....................................................................................................................................................#
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 0_startingTasks|74
#	secondaryAppearInSection: >none
#	input: none
...
#	dependOnSub: currentTime|293
#	appearInSub: checkBedGraphToBigWigVersion|161, convertCTSS|211, getTotalCount|311
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 3_count|109
#	input: $lineEnd, $message, $numTrailingSpace
#	output: 
#	toCall: &reportAndLogStatus($message, $numTrailingSpace, $lineEnd);
#	calledInLine: 177, 182, 253, 267, 270, 324, 337
#....................................................................................................................................................#
	...
	print "[".&currentTime()."] ".$message.$trailingSpaces.$lineEnd;#->293
	print $tmplog_fh "[".&currentTime()."] ".$message.$lineEnd if $lineEnd ne "\r";#->293

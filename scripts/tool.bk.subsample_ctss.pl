...
=head1 SYNOPSIS
 ...
 Single Cell Analysis of Five'End (SCAFE) Suite: --> tool.bk.subsample_ctss.pl <--
 ...
 For demo, cd to SCAFE dir and run,
   ./scripts/tool.bk.subsample_ctss.pl \
   --overwrite=yes \
...
my ($curntTimeStamp) = &timeStamp();#->599
my $ARGVStr = join "\n", (&currentTime(), $scriptAbsPath, @ARGV);#->202
...
my ($long_ctss_bed_path, $subsample_num, $outputPrefix, $outDir, $overwrite) = &readParameters();#->437
#<\section>
#====================================================================================================================================================#
...
&logCalledCMDAndScript($ARGVStr, $result_script_dir, $scriptAbsPath);#->263
&printStartOrFinishMessage("startMessage");#->403
#<\section>
#====================================================================================================================================================#
...
my ($bedtools_bin) = &checkBedtoolsVersion();#->178
my ($target_fraction) = &getTargetFraction($long_ctss_bed_path, $subsample_num);#->220
&subsampleCTSS($long_ctss_bed_path, $result_bed_dir, $bedtools_bin, $target_fraction, $outputPrefix);#->503
#<\section>
#====================================================================================================================================================#
...
&printOutputFileListAndReadme($ARGVStr, $paramTag, $outDir);#->288
&printStartOrFinishMessage("finishMessage");#->403
#<\section>
#====================================================================================================================================================#
...
#
#	unassigned [n=2]:
#		getTargetFraction, subsampleCTSS
#
#====================================================================================================================================================#
...
#	dependOnSub: reportAndLogStatus|481
#	appearInSub: >none
#	primaryAppearInSection: 3_subsample|124
...
#	dependOnSub: >none
#	appearInSub: printStartOrFinishMessage|403, reportAndLogStatus|481
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 2_defineOutDirPath|107, 5_finishingTasks|141
#	input: none
#	output: $runTime
#	toCall: my ($runTime) = &currentTime();
#	calledInLine: 80, 419, 423, 428, 432, 497, 498
#....................................................................................................................................................#
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 2_defineOutDirPath|107
#	secondaryAppearInSection: >none
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 5_finishingTasks|141
#	secondaryAppearInSection: >none
...
#....................................................................................................................................................#
#	subroutineCategory: general
#	dependOnSub: currentTime|202
#	appearInSub: >none
#	primaryAppearInSection: 2_defineOutDirPath|107, 5_finishingTasks|141
#	secondaryAppearInSection: >none
#	input: $StartOrFinishMessage
#	output: none
#	toCall: &printStartOrFinishMessage($StartOrFinishMessage);
#	calledInLine: 119, 145
#....................................................................................................................................................#
...
#	dependOnSub: currentTime|202
#	appearInSub: checkBedtoolsVersion|178, getTargetFraction|220, subsampleCTSS|503
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 3_subsample|124
#	input: $lineEnd, $message, $numTrailingSpace
#	output: 
#	toCall: &reportAndLogStatus($message, $numTrailingSpace, $lineEnd);
#	calledInLine: 194, 233, 251, 252, 255, 256, 257, 258, 566
#....................................................................................................................................................#
	...
	print "[".&currentTime()."] ".$message.$trailingSpaces.$lineEnd;#->202
	print $tmplog_fh "[".&currentTime()."] ".$message.$lineEnd if $lineEnd ne "\r";#->202
...
#	calledInLine: 129
#....................................................................................................................................................#
	my ($long_ctss_bed_path, $result_bed_dir, $bedtools_bin, $target_fraction, $outputPrefix) = @_;
	...
	system "gzip $sub_collapse_ctss_bed_path";
	system "gzip $sub_ung_collapse_ctss_bed_path";
	system "gzip $sub_long_ctss_bed_path";

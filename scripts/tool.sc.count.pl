...
=head1 SYNOPSIS
 ...
 Single Cell Analysis of Five'End (SCAFE) Suite: --> tool.sc.count.pl <--
...
my ($curntTimeStamp) = &timeStamp();#->693
my $ARGVStr = join "\n", (&currentTime(), $scriptAbsPath, @ARGV);#->214
...
my ($countRegion_bed_path, $ctss_bed_path, $cellBarcode_list_path, $outputPrefix, $outDir, $overwrite) = &readParameters();#->545
#<\section>
#====================================================================================================================================================#
...
&logCalledCMDAndScript($ARGVStr, $result_script_dir, $scriptAbsPath);#->232
&printStartOrFinishMessage("startMessage");#->428
my ($bedtools_bin) = &checkBedtoolsVersion();#->183
#<\section>
#====================================================================================================================================================#
...
my ($countRegion_info_hsh_ref) = &readCountRegionInfo($countRegion_bed_path);#->502
my ($cellBarcode_info_hsh_ref) = &readCellBarcodeList($cellBarcode_list_path);#->462
my ($tmp_count_path) = &runBedToolsIntersect($countRegion_bed_path, $ctss_bed_path, $countRegion_info_hsh_ref, $cellBarcode_info_hsh_ref, $result_matrix_dir, $result_log_dir, $bedtools_bin);#->612
&printMatrix($countRegion_info_hsh_ref, $cellBarcode_info_hsh_ref, $tmp_count_path, $result_log_dir, $result_matrix_dir);#->257
#<\section>
#====================================================================================================================================================#
...
&printOutputFileListAndReadme($ARGVStr, $paramTag, $outDir);#->313
&printStartOrFinishMessage("finishMessage");#->428
#<\section>
#====================================================================================================================================================#
...
#
#	unassigned [n=3]:
#		printMatrix, readCellBarcodeList, readCountRegionInfo
#
#====================================================================================================================================================#
...
#	dependOnSub: reportAndLogStatus|590
#	appearInSub: >none
#	primaryAppearInSection: 2_defineOutDirPath|113
...
#	dependOnSub: >none
#	appearInSub: printStartOrFinishMessage|428, reportAndLogStatus|590
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 2_defineOutDirPath|113, 4_finishingTasks|143
#	input: none
#	output: $runTime
#	toCall: my ($runTime) = &currentTime();
#	calledInLine: 86, 444, 448, 453, 457, 606, 607
#....................................................................................................................................................#
...
#	dependOnSub: reportAndLogStatus|590
#	appearInSub: >none
#	primaryAppearInSection: 3_output|132
#	secondaryAppearInSection: >none
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 4_finishingTasks|143
#	secondaryAppearInSection: >none
...
#	appearInSub: >none
#	primaryAppearInSection: 2_defineOutDirPath|113, 4_finishingTasks|143
#	secondaryAppearInSection: >none
#	input: $StartOrFinishMessage
#	output: none
#	toCall: &printStartOrFinishMessage($StartOrFinishMessage);
#	calledInLine: 126, 147
#....................................................................................................................................................#
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 0_startingTasks|97
#	secondaryAppearInSection: >none
#	input: none
#	output: $cellBarcode_list_path, $countRegion_bed_path, $ctss_bed_path, $outDir, $outputPrefix, $overwrite
#	toCall: my ($countRegion_bed_path, $ctss_bed_path, $cellBarcode_list_path, $outputPrefix, $outDir, $overwrite) = &readParameters();
#	calledInLine: 100
#....................................................................................................................................................#
	
	my ($countRegion_bed_path, $ctss_bed_path, $cellBarcode_list_path, $outputPrefix, $outDir, $overwrite);
	$overwrite = 'no';
	...
	return($countRegion_bed_path, $ctss_bed_path, $cellBarcode_list_path, $outputPrefix, $outDir, $overwrite);
}
sub reportAndLogStatus {
#....................................................................................................................................................#
#	subroutineCategory: log
#	dependOnSub: currentTime|214
#	appearInSub: checkBedtoolsVersion|183, printMatrix|257, readCellBarcodeList|462, readCountRegionInfo|502, runBedToolsIntersect|612
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 2_defineOutDirPath|113, 3_output|132
#	input: $lineEnd, $message, $numTrailingSpace
#	output: 
#	toCall: &reportAndLogStatus($message, $numTrailingSpace, $lineEnd);
#	calledInLine: 201, 205, 270, 477, 497, 517, 540, 632, 668, 685
#....................................................................................................................................................#
	...
	print $tmplog_fh "[".&currentTime()."] ".$message.$lineEnd if $lineEnd ne "\r";#->214
...
#	primaryAppearInSection: 3_output|132
#	secondaryAppearInSection: >none
#	input: $bedtools_bin, $cellBarcode_info_hsh_ref, $countRegion_bed_path, $countRegion_info_hsh_ref, $ctss_bed_path, $result_log_dir, $result_matrix_dir
#	output: $tmp_count_path
#	toCall: my ($tmp_count_path) = &runBedToolsIntersect($countRegion_bed_path, $ctss_bed_path, $countRegion_info_hsh_ref, $cellBarcode_info_hsh_ref, $result_matrix_dir, $result_log_dir, $bedtools_bin);
#	calledInLine: 137
#....................................................................................................................................................#

	my ($countRegion_bed_path, $ctss_bed_path, $countRegion_info_hsh_ref, $cellBarcode_info_hsh_ref, $result_matrix_dir, $result_log_dir, $bedtools_bin) = @_;

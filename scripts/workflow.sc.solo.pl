...
=head1 SYNOPSIS
 ...
 Single Cell Analysis of Five'End (SCAFE) Suite: --> workflow.sc.solo.pl <--
...
&run_task($task_info_hsh_ref, $path_hsh_ref);#->453
#<\section>
#====================================================================================================================================================#
...
#....................................................................................................................................................#
	...
	my $task_info_hsh_ref = {
		1 => {
			...
			'script_name' => 'tool.sc.bam_to_ctss.pl',
			'param' => [
				['genome', $genome],
		...
		7 => {
			...
			'check' => [
				...
				$run_outDir."/count/$run_tag/matrix/matrix/genes.tsv",
				$run_outDir."/count/$run_tag/matrix/matrix/barcodes.tsv",
			]
		},
	};
...
#....................................................................................................................................................#
	...
	my $ARGVStr = join "\n", (&currentTime(), $scriptAbsPath, @{$ARGV_ary_ref});#->150

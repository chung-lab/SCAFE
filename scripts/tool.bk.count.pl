...
=head1 SYNOPSIS
 ...
 Single Cell Analysis of Five'End (SCAFE) Suite: --> tool.bk.count.pl <--
...
my ($curntTimeStamp) = &timeStamp();#->562
my $ARGVStr = join "\n", (&currentTime(), $scriptAbsPath, @ARGV);#->203
...
my ($countRegion_bed_path, $ctss_bed_path, $outputPrefix, $outDir, $overwrite) = &readParameters();#->461
#<\section>
#====================================================================================================================================================#
...
&logCalledCMDAndScript($ARGVStr, $result_script_dir, $scriptAbsPath);#->221
&printStartOrFinishMessage("startMessage");#->387
...
my ($countRegion_info_hsh_ref) = &readCountRegionInfo($countRegion_bed_path);#->421
&runBedToolsIntersect($countRegion_bed_path, $ctss_bed_path, $countRegion_info_hsh_ref, $bedtools_bin);#->525
&printCount($countRegion_info_hsh_ref, $result_log_dir);#->246
#<\section>
#====================================================================================================================================================#
...
&printOutputFileListAndReadme($ARGVStr, $paramTag, $outDir);#->272
&printStartOrFinishMessage("finishMessage");#->387
#<\section>
#====================================================================================================================================================#
...
#
#	unassigned [n=2]:
#		printCount, readCountRegionInfo
#
#====================================================================================================================================================#
...
#	dependOnSub: reportAndLogStatus|503
#	appearInSub: >none
#	primaryAppearInSection: 2_defineOutDirPath|110
...
#	dependOnSub: >none
#	appearInSub: printStartOrFinishMessage|387, reportAndLogStatus|503
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 2_defineOutDirPath|110, 4_finishingTasks|139
#	input: none
#	output: $runTime
#	toCall: my ($runTime) = &currentTime();
#	calledInLine: 83, 403, 407, 412, 416, 519, 520
#....................................................................................................................................................#
...
#	dependOnSub: reportAndLogStatus|503
#	appearInSub: >none
#	primaryAppearInSection: 3_output|129
#	secondaryAppearInSection: >none
...
#....................................................................................................................................................#
	...
	open (COUNTLOG, ">", "$result_log_dir/count.log.tsv");
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 4_finishingTasks|139
#	secondaryAppearInSection: >none
...
#....................................................................................................................................................#
#	subroutineCategory: general
#	dependOnSub: currentTime|203
#	appearInSub: >none
#	primaryAppearInSection: 2_defineOutDirPath|110, 4_finishingTasks|139
#	secondaryAppearInSection: >none
#	input: $StartOrFinishMessage
#	output: none
#	toCall: &printStartOrFinishMessage($StartOrFinishMessage);
#	calledInLine: 123, 143
#....................................................................................................................................................#
...
#	dependOnSub: currentTime|203
#	appearInSub: checkBedtoolsVersion|179, printCount|246, readCountRegionInfo|421, runBedToolsIntersect|525
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 2_defineOutDirPath|110, 3_output|129
#	input: $lineEnd, $message, $numTrailingSpace
#	output: 
#	toCall: &reportAndLogStatus($message, $numTrailingSpace, $lineEnd);
#	calledInLine: 195, 259, 436, 456, 539
#....................................................................................................................................................#
	...
	print "[".&currentTime()."] ".$message.$trailingSpaces.$lineEnd;#->203
	print $tmplog_fh "[".&currentTime()."] ".$message.$lineEnd if $lineEnd ne "\r";#->203

...
=head1 SYNOPSIS
 ...
 Single Cell Analysis of Five'End (SCAFE) Suite: --> tool.cm.prep_genome.pl <--
 ...
 For demo, cd to SCAFE dir and run,
   ./scripts/tool.cm.prep_genome.pl \
   --overwrite=yes \
...
my ($curntTimeStamp) = &timeStamp();#->1099
my $ARGVStr = join "\n", (&currentTime(), $scriptAbsPath, @ARGV);#->319
...
my ($gtf_path, $fasta_path, $chrom_list_path, $mask_bed_path, $outputPrefix, $outDir, $overwrite) = &readParameters();#->999
#<\section>
#====================================================================================================================================================#
...
&printStartOrFinishMessage("startMessage");#->681
&logCalledCMDAndScript($ARGVStr, $result_script_dir, $scriptAbsPath);#->412
#<\section>
#====================================================================================================================================================#
...
my ($bedtools_bin) = &checkBedtoolsVersion();#->207
my ($samtools_bin) = &checkSamtoolsVersion();#->238
my ($out_fasta_path, $out_fai_path, $out_gtf_path, $out_mask_bed_path) = &copySourceFile($gtf_path, $fasta_path, $samtools_bin, $mask_bed_path, $result_bed_dir, $result_fasta_dir, $result_gtf_dir);#->268
my ($chromSizeHsh_ref) = &readChromSize($out_fai_path, $chrom_list_path, $result_tsv_dir);#->790
my ($geneInfoHsh_ref) = &readGTF($gtf_path, $chromSizeHsh_ref);#->842
my ($annoRegHsh_ref) = &generateAnnotationRegion($geneInfoHsh_ref, $flankSize_ary_ref, $chromSizeHsh_ref, $result_bed_dir);#->337
my ($subtract_bed_hsh_ref, $region_bed_hsh_ref) = &printRegionBed($annoRegHsh_ref, $outputPrefix, $result_bed_dir, $bedtools_bin);#->621
&subtractMask($region_bed_hsh_ref, $mask_bed_path, $bedtools_bin, $result_bed_dir, $subtract_bed_hsh_ref);#->1069
&printTranscriptBed($geneInfoHsh_ref, $outputPrefix, $result_bed_dir);#->715
&printGeneInfo($geneInfoHsh_ref, $outputPrefix, $result_tsv_dir);#->437
#<\section>
#====================================================================================================================================================#
...
&printOutputFileListAndReadme($ARGVStr, $paramTag, $outDir);#->501
&printStartOrFinishMessage("finishMessage");#->681
close $tmplog_fh;
#<\section>
#====================================================================================================================================================#
...
#
#	unassigned [n=4]:
#		copySourceFile, generateAnnotationRegion, readChromSize
#		subtractMask
#
#====================================================================================================================================================#
...
#	dependOnSub: reportAndLogStatus|1047
#	appearInSub: >none
#	primaryAppearInSection: 3_processInputData|144
...
#	dependOnSub: >none
#	appearInSub: printStartOrFinishMessage|681, reportAndLogStatus|1047
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 2_defineOutDirPath|124, 4_finishingTasks|161
#	input: none
#	output: $runTime
#	toCall: my ($runTime) = &currentTime();
#	calledInLine: 96, 697, 701, 706, 710, 1063, 1064
#....................................................................................................................................................#
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 2_defineOutDirPath|124
#	secondaryAppearInSection: >none
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 4_finishingTasks|161
#	secondaryAppearInSection: >none
...
#....................................................................................................................................................#
#	subroutineCategory: general
#	dependOnSub: currentTime|319
#	appearInSub: >none
#	primaryAppearInSection: 2_defineOutDirPath|124, 4_finishingTasks|161
#	secondaryAppearInSection: >none
#	input: $StartOrFinishMessage
#	output: none
#	toCall: &printStartOrFinishMessage($StartOrFinishMessage);
#	calledInLine: 138, 165
#....................................................................................................................................................#
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 0_startingTasks|107
#	secondaryAppearInSection: >none
#	input: none
...
#	dependOnSub: currentTime|319
#	appearInSub: checkBedtoolsVersion|207, checkSamtoolsVersion|238, copySourceFile|268, generateAnnotationRegion|337, printGeneInfo|437, printRegionBed|621, printTranscriptBed|715, readGTF|842, subtractMask|1069
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 3_processInputData|144
#	input: $lineEnd, $message, $numTrailingSpace
#	output: 
#	toCall: &reportAndLogStatus($message, $numTrailingSpace, $lineEnd);
#	calledInLine: 225, 229, 255, 259, 286, 295, 298, 307, 352, 357, 407, 466, 637, 737, 866, 884, 893, 894, 895, 993, 994, 1087
#....................................................................................................................................................#
	...
	print "[".&currentTime()."] ".$message.$trailingSpaces.$lineEnd;#->319
	print $tmplog_fh "[".&currentTime()."] ".$message.$lineEnd if $lineEnd ne "\r";#->319
	...
	foreach my $bedID (keys %{$region_bed_hsh_ref}) {
		if ($bedID =~ m/exon/ or $bedID =~ m/intron/) {
			...
			foreach my $subtract_annotype (keys %{$subtract_bed_hsh_ref}) {
				...
				system "$bedtools_bin subtract -a $region_bed_path -b $subtract_annotype_bed_path | gzip -c >$subtracted_region_bed_path";
			}
		}
	}

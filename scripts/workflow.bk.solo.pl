...
=head1 SYNOPSIS
 ...
 Single Cell Analysis of Five'End (SCAFE) Suite: --> workflow.bk.solo.pl <--
...
my ($run_bam_path, $genome, $training_signal_path, $testing_signal_path, $max_thread, $run_tag, $run_outDir, $overwrite) = &readParameters();#->374
$max_thread = 10 if $max_thread > 10;
my ($scafe_dir, $script_dir, $result_script_dir, $ARGVStr, $scriptAbsPath) = &prepDir($run_outDir, $ARGV_ary_ref);#->346
&logCalledCMDAndScript($ARGVStr, $result_script_dir, $scriptAbsPath);#->321
#<\section>
#====================================================================================================================================================#
...
my ($path_hsh_ref) = &define_path($run_outDir, $run_tag, $run_bam_path, $training_signal_path, $testing_signal_path, $script_dir);#->165
my ($task_info_hsh_ref) = &define_task($genome, $path_hsh_ref, $max_thread, $run_tag, $run_outDir);#->206
&run_task($task_info_hsh_ref, $path_hsh_ref);#->424
#<\section>
#====================================================================================================================================================#
...
#	dependOnSub: >none
#	appearInSub: prepDir|346
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 0_startTasks|109
#	input: none
#	output: $runTime
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 1_run|121
#	secondaryAppearInSection: >none
#	input: $run_bam_path, $run_outDir, $run_tag, $script_dir, $testing_signal_path, $training_signal_path
#	output: $path_hsh_ref
#	toCall: my ($path_hsh_ref) = &define_path($run_outDir, $run_tag, $run_bam_path, $training_signal_path, $testing_signal_path, $script_dir);
#	calledInLine: 124
#....................................................................................................................................................#

	my ($run_outDir, $run_tag, $run_bam_path, $training_signal_path, $testing_signal_path, $script_dir) = @_;
	...
	my $path_hsh_ref = {
		...
		'long_ctss_bed_path' => $run_outDir."/bam_to_ctss/".$run_tag."/bed/".$run_tag.".long.ctss.bed.gz",
...
#....................................................................................................................................................#
	...
	my $task_info_hsh_ref = {
		1 => {
			...
			'script_name' => 'tool.bk.bam_to_ctss.pl',
			'param' => [
				['genome', $genome],
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 0_startTasks|109
#	secondaryAppearInSection: >none
...
#....................................................................................................................................................#
	...
	my $ARGVStr = join "\n", (&currentTime(), $scriptAbsPath, @{$ARGV_ary_ref});#->147
...
#	secondaryAppearInSection: >none
#	input: none
#	output: $genome, $max_thread, $overwrite, $run_bam_path, $run_outDir, $run_tag, $testing_signal_path, $training_signal_path
#	toCall: my ($run_bam_path, $genome, $training_signal_path, $testing_signal_path, $max_thread, $run_tag, $run_outDir, $overwrite) = &readParameters();
#	calledInLine: 113
#....................................................................................................................................................#
	
	my ($run_bam_path, $genome, $training_signal_path, $testing_signal_path, $max_thread, $run_tag, $run_outDir, $overwrite);
	...
	return($run_bam_path, $genome, $training_signal_path, $testing_signal_path, $max_thread, $run_tag, $run_outDir, $overwrite);

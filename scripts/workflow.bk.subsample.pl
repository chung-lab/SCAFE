...
=head1 SYNOPSIS
 ...
 Single Cell Analysis of Five'End (SCAFE) Suite: --> workflow.bk.subsample.pl <--
 ...
 For demo without training, cd to SCAFE dir and run,
   ./scripts/workflow.bk.subsample.pl \
   --overwrite=yes \
...
my ($long_ctss_bed_path, $subsample_num, $genome, $training_signal_path, $testing_signal_path, $max_thread, $run_tag, $run_outDir, $overwrite) = &readParameters();#->381
$max_thread = 10 if $max_thread > 10;
my ($scafe_dir, $script_dir, $result_script_dir, $ARGVStr, $scriptAbsPath) = &prepDir($run_outDir, $ARGV_ary_ref);#->353
&logCalledCMDAndScript($ARGVStr, $result_script_dir, $scriptAbsPath);#->328
#<\section>
#====================================================================================================================================================#
...
my ($path_hsh_ref) = &define_path($run_outDir, $run_tag, $long_ctss_bed_path, $training_signal_path, $testing_signal_path, $script_dir);#->169
my ($task_info_hsh_ref) = &define_task($genome, $path_hsh_ref, $max_thread, $subsample_num, $run_tag, $run_outDir);#->214
&run_task($task_info_hsh_ref, $path_hsh_ref);#->432
#<\section>
#====================================================================================================================================================#
...
#	dependOnSub: >none
#	appearInSub: prepDir|353
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 0_startTasks|113
#	input: none
#	output: $runTime
...
#	input: $long_ctss_bed_path, $run_outDir, $run_tag, $script_dir, $testing_signal_path, $training_signal_path
#	output: $path_hsh_ref
#	toCall: my ($path_hsh_ref) = &define_path($run_outDir, $run_tag, $long_ctss_bed_path, $training_signal_path, $testing_signal_path, $script_dir);
#	calledInLine: 128
#....................................................................................................................................................#

	my ($run_outDir, $run_tag, $long_ctss_bed_path, $training_signal_path, $testing_signal_path, $script_dir) = @_;
...
#....................................................................................................................................................#
	...
	my $task_info_hsh_ref = {
		1 => {
			...
			'script_name' => 'tool.bk.subsample_ctss.pl',
			'param' => [
		...
		6 => {
			...
			'check' => [
				$run_outDir."/count/$run_tag/log/count.log.tsv",
			]
		},
	};
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 0_startTasks|113
#	secondaryAppearInSection: >none
...
#....................................................................................................................................................#
	...
	my $ARGVStr = join "\n", (&currentTime(), $scriptAbsPath, @{$ARGV_ary_ref});#->151
...
#	secondaryAppearInSection: >none
#	input: none
#	output: $genome, $long_ctss_bed_path, $max_thread, $overwrite, $run_outDir, $run_tag, $subsample_num, $testing_signal_path, $training_signal_path
#	toCall: my ($long_ctss_bed_path, $subsample_num, $genome, $training_signal_path, $testing_signal_path, $max_thread, $run_tag, $run_outDir, $overwrite) = &readParameters();
#	calledInLine: 117
#....................................................................................................................................................#
	
	my ($long_ctss_bed_path, $subsample_num, $genome, $training_signal_path, $testing_signal_path, $max_thread, $run_tag, $run_outDir, $overwrite);
	...
	return($long_ctss_bed_path, $subsample_num, $genome, $training_signal_path, $testing_signal_path, $max_thread, $run_tag, $run_outDir, $overwrite);

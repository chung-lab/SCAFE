...
=head1 SYNOPSIS
 ...
 Single Cell Analysis of Five'End (SCAFE) Suite: --> tool.sc.subsample_ctss.pl <--
 ...
 For demo, cd to SCAFE dir and run,
   ./scripts/tool.sc.subsample_ctss.pl \
   --overwrite=yes \
...
my ($curntTimeStamp) = &timeStamp();#->642
my $ARGVStr = join "\n", (&currentTime(), $scriptAbsPath, @ARGV);#->210
...
my ($UMI_CB_ctss_bed_path, $subsample_num, $outputPrefix, $outDir, $overwrite) = &readParameters();#->445
#<\section>
#====================================================================================================================================================#
...
&logCalledCMDAndScript($ARGVStr, $result_script_dir, $scriptAbsPath);#->271
&printStartOrFinishMessage("startMessage");#->411
#<\section>
#====================================================================================================================================================#
...
my ($bedtools_bin) = &checkBedtoolsVersion();#->179
my ($target_fraction) = &getTargetFraction($UMI_CB_ctss_bed_path, $subsample_num);#->228
&subsampleCTSS($UMI_CB_ctss_bed_path, $result_bed_dir, $bedtools_bin, $target_fraction, $outputPrefix);#->511
#<\section>
#====================================================================================================================================================#
...
&printOutputFileListAndReadme($ARGVStr, $paramTag, $outDir);#->296
&printStartOrFinishMessage("finishMessage");#->411
#<\section>
#====================================================================================================================================================#
...
#	dependOnSub: reportAndLogStatus|489
#	appearInSub: >none
#	primaryAppearInSection: 3_subsample|125
...
#	dependOnSub: >none
#	appearInSub: printStartOrFinishMessage|411, reportAndLogStatus|489
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 2_defineOutDirPath|108, 5_finishingTasks|142
#	input: none
#	output: $runTime
#	toCall: my ($runTime) = &currentTime();
#	calledInLine: 81, 427, 431, 436, 440, 505, 506
#....................................................................................................................................................#
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 5_finishingTasks|142
#	secondaryAppearInSection: >none
...
#....................................................................................................................................................#
#	subroutineCategory: general
#	dependOnSub: currentTime|210
#	appearInSub: >none
#	primaryAppearInSection: 2_defineOutDirPath|108, 5_finishingTasks|142
#	secondaryAppearInSection: >none
...
#	dependOnSub: currentTime|210
#	appearInSub: checkBedtoolsVersion|179, getTargetFraction|228, subsampleCTSS|511
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 3_subsample|125
#	input: $lineEnd, $message, $numTrailingSpace
#	output: 
#	toCall: &reportAndLogStatus($message, $numTrailingSpace, $lineEnd);
#	calledInLine: 197, 201, 241, 259, 260, 263, 264, 265, 266, 550
#....................................................................................................................................................#
	...
	print "[".&currentTime()."] ".$message.$trailingSpaces.$lineEnd;#->210
	print $tmplog_fh "[".&currentTime()."] ".$message.$lineEnd if $lineEnd ne "\r";#->210
...
#	calledInLine: 130
#....................................................................................................................................................#
	my ($UMI_CB_ctss_bed_path, $result_bed_dir, $bedtools_bin, $target_fraction, $outputPrefix) = @_;
	...
	system "gzip $sub_CB_ctss_bed_path";

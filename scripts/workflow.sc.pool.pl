...
=head1 SYNOPSIS
 ...
 Single Cell Analysis of Five'End (SCAFE) Suite: --> workflow.sc.pool.pl <--
...
my ($lib_list_path, $genome, $training_signal_path, $testing_signal_path, $max_thread, $run_tag, $run_outDir, $overwrite) = &readParameters();#->431
my ($scafe_dir, $script_dir, $result_script_dir, $ARGVStr, $scriptAbsPath) = &prepDir($run_outDir, $ARGV_ary_ref);#->403
&logCalledCMDAndScript($ARGVStr, $result_script_dir, $scriptAbsPath);#->378
#<\section>
#====================================================================================================================================================#
...
my ($path_hsh_ref) = &define_path($run_outDir, $run_tag, $lib_list_path, $training_signal_path, $testing_signal_path, $script_dir);#->214
my ($task_info_hsh_ref) = &define_task($genome, $path_hsh_ref, $max_thread, $run_tag, $run_outDir);#->262
&addCountIndivLibTask($path_hsh_ref, $task_info_hsh_ref, $run_tag, $run_outDir);#->153
&run_task($task_info_hsh_ref, $path_hsh_ref);#->481
#<\section>
#====================================================================================================================================================#
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 1_run|126
...
#....................................................................................................................................................#
	...
	while (<CTSSLIST>) {
		chomp;
		my ($libID, $priority, $CB_UMI_ctss_bed_path, $run_cellbarcode_path, $CB_ctss_bed_path) = split /\t/;
		my $outputPrefix = $libID;
		my $task_outDir = "$run_outDir/count/";
		$task_num++;
		$task_info_hsh_ref->{$task_num} = {
			'task_name' => 'count',
			'script_name' => 'tool.sc.count.pl',
			'param' => [
				['countRegion_bed_path', $path_hsh_ref->{"tCRE_bed_path"}],
				['ctss_bed_path', $CB_ctss_bed_path],
				['cellBarcode_list_path', $run_cellbarcode_path],
				['outputPrefix', $outputPrefix],
				['outDir', $run_outDir."/count"],
			],
			'check' => [
				$run_outDir."/count/$outputPrefix/matrix/matrix.mtx",
				$run_outDir."/count/$outputPrefix/matrix/matrix/genes.tsv",
				$run_outDir."/count/$outputPrefix/matrix/matrix/barcodes.tsv",
			]
		};
	}
	close CTSSLIST;
...
#	dependOnSub: >none
#	appearInSub: prepDir|403
#	primaryAppearInSection: >none
#	secondaryAppearInSection: 0_startTasks|115
#	input: none
#	output: $runTime
...
#....................................................................................................................................................#
	...
	my $path_hsh_ref = {
		...
		'run_cellbarcode_path' => $run_outDir."/pool/".$run_tag."/log/".$run_tag.".pool.cellbarcodes.tsv.gz",
		'CB_ctss_bed_path' => $run_outDir."/pool/".$run_tag."/bed/".$run_tag.".pool.CB.ctss.bed.gz",
	...
	my $task_info_hsh_ref = {
		1 => {
			...
			'check' => [
				 ...
				 $path_hsh_ref->{'run_cellbarcode_path'},
			]
		},
		2 => {
			'task_name' => 'remove_strand_invader',
			'script_name' => 'tool.cm.remove_strand_invader.pl',
			'param' => [
		...
		3 => {
			...
			'param' => [
				...
				['count_ctss_bed_path_list', $path_hsh_ref->{'filtered_ctss_bed_path'}],
				['count_scope_bed_path', $path_hsh_ref->{'filtered_ctss_bed_path'}],
				['outputPrefix', $run_tag],
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 0_startTasks|115
#	secondaryAppearInSection: >none
...
#....................................................................................................................................................#
	...
	my $ARGVStr = join "\n", (&currentTime(), $scriptAbsPath, @{$ARGV_ary_ref});#->196
...
#	dependOnSub: >none
#	appearInSub: >none
#	primaryAppearInSection: 1_run|125
#	secondaryAppearInSection: >none
